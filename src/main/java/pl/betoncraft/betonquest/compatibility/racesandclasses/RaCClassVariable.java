 ...
 */
public class RaCClassVariable extends Variable<ClassContainer> {
  ...
  @Override
  public ClassContainer getValue(String playerID) {
    return ClassAPI.getClassOfPlayer(PlayerConverter.getPlayer(playerID));
  }

  @Override
  public String getValueAsString(String playerID) {
    final ClassContainer container = getValue(playerID);
    return container == null ? "none" : container.getDisplayName();
  }
}
