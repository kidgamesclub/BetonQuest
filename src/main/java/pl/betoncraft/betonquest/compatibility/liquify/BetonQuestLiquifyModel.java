...
public class BetonQuestLiquifyModel extends PlaceholderExtender {
  ...
  public Object resolvePlaceholder(LiquidModelMap liquidModelMap) {
    ...
    final Player player = liquidModelMap.getPlayer();
    String pack = null;
    if (player != null) {
      ...
      if (identifier.contains(":")) {
        ...
        pack = betonQuest.getConfig().getString("default_package", "default");
      }
      return betonQuest.getVariableValue(pack, '%' + identifier + '%', PlayerConverter.getID(player));
    }
    return null;
  }
}
