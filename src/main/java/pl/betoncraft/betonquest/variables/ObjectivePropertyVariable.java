 ...
 */
public class ObjectivePropertyVariable extends Variable<Object> {
  ...
  @Override
  public Object getValue(String playerID) {
    ...
    return (objective.containsPlayer(playerID) ? objective.getReadableProperty(propertyName, playerID) : "");
  }
}
