...
public class LocationVariable extends Variable<Location> {
  ...
  @Override
  public Location getValue(String playerID) {
    return PlayerConverter.getPlayer(playerID).getLocation();
  }

	@Override
	public String getValueAsString(String playerID) {
    final Location loc = getValue(playerID);
